...
namespace DataAccessLibrary
{
    public class StoreData : IStoreData
    {
        ...
        VALUES (@UserId, GETDATE(), @SupplierId, @TotalAmount)";
        ...
        VALUES (@OrderId, @ProductId, @QuantityOrdered, @UnitPrice)";
            ...
            string shipmentSql = @"
        INSERT INTO Shipment (Order_Id, Shipment_Date, Estimated_Arrival_Date, Shipment_Confirmation) 
        VALUES (@OrderId, GETDATE(), DATEADD(DAY, 7, GETDATE()), 'Pending')"; // Default to 'Pending' with a 7-day estimate
            ...
            await _db.SaveData(shipmentSql, shipmentParameters);
